...
ai-vocabulary = true           # delve, robust, leverage, unlock, tapestry, ...
rhetorical-question-chain = true # 2+ consecutive questions
vague-attribution = true       # experts say, studies show, research shows, ...
count-opening = true           # three things, two reasons, a few notes, ...
